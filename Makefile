...
gen-sbo-artifacts: package-building/pkgtools-extras.info package-building/pkgtools-extras.SlackBuild package-building/slack-desc package-building/README.SBO gen-source-package
	MD5SUM=$(shell md5sum dist/pkgtools-extras-$(VERSION).tar.gz)
	mkdir -p dist
